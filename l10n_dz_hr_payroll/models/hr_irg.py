...
class HrIrg(models.Model):
    ...
    #print ''
    #print 'Exemples Pour 119 850.0 DA:', irg(119850.00)
    #print '--------  '
    #print 'Exemples Pour 50 080.0 DA:', irg(50080.0)
    #print '--------  '
    #print 'Exemples Pour 30 000.0 DA:', irg(30000.0)
    #print '--------  '
    #print 'Exemples Pour 15 000.0 DA:', irg(15000.0)
